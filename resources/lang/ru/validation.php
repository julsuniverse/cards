...
return [
    ...
    */
    ...
    'min' => [
        ...
        'string' => 'Поле :attribute должно содерать минимум :min символов.',
    ...
    */
    ...
    'custom' => [
        'email' => [
            'unique' => 'Пользователь с таким email уже существует. Введите другой имейл или войдите в свой аккаунт.',
        ],
    ],
